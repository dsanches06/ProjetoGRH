 ...
 * @author
 */
public class PainelQuestionarioCompetencias extends StackPane {
    ...
    public PainelQuestionarioCompetencias(BorderPane root, Empresa empresa, Gestores gestora, Funcionario funcionario) {
    ...
    private void mostrarQuestionario(BorderPane root, VBox vbox3, Empresa empresa, Gestores gestora, Funcionario funcionario) {
        ...
        Text titulo = new Text("Questionário sobre Competências");
        ...
        Label pergunta1 = new Label("01  -  Seus conhecimentos são mínimos ocasionando"
                + "\n\t erros que prejudicam o andamento do trabalho?");
        ...
        HBox hbox1 = new HBox(56);
        hbox1.getChildren().addAll(pergunta1, hboxCheck1);

        Label pergunta2 = new Label("02  -  Apresenta grande preparo e competência"
        ...
        HBox hbox2 = new HBox(101);
        hbox2.getChildren().addAll(pergunta2, hboxCheck2);

        Label pergunta3 = new Label("03  -  Os conhecimentos que possui são suficientes"
        ...
        HBox hbox3 = new HBox(72);
        hbox3.getChildren().addAll(pergunta3, hboxCheck3);

        Label pergunta4 = new Label("04  -  Demonstra iniciativa e vontade de aceitar"
                + "\n\t novos desafios?");
        ...
        Label pergunta5 = new Label("05  -  Suporta pressões e adaptar-se à situações "
                + "\n\t e contexto variado?");
        ...
        btnCancelar.setOnAction((ActionEvent e) -> {
            ...
            float mediaCompetencia = total / 5;
            funcionario.calcularAvaliacao(TipoAvaliacao.COMPETENCIAS, mediaCompetencia);
        ...
        btnAvancar.setOnAction((ActionEvent e) -> {
            if (!chk11.isSelected() && !chk12.isSelected()
                ...
                float mediaCompetencia = total / 5;
                funcionario.calcularAvaliacao(TipoAvaliacao.COMPETENCIAS, mediaCompetencia);
                painelQuestionarioComunicacao(root, empresa, gestora, funcionario);
            }
        });

        VBox vboxDireito = new VBox(32);
    ...
    private StackPane painelQuestionarioComunicacao(BorderPane root, Empresa empresa, Gestores gestora, Funcionario funcionario) {
        return new PainelQuestionarioComunicacao(root, empresa, gestora, funcionario);
    }
