 ...
 * @author
 */
public class PainelQuestionarioLideranca extends StackPane {
    ...
    public PainelQuestionarioLideranca(BorderPane root, Empresa empresa, Gestores gestora, Funcionario funcionario) {
    ...
    private void mostrarQuestionario(BorderPane root, VBox vbox3, Empresa empresa, Gestores gestora, Funcionario funcionario) {
        ...
        Text titulo = new Text("Questionário sobre Liderança");
        ...
        Label pergunta1 = new Label("01  -  Domina os conhecimentos necessários para"
        ...
        Label pergunta2 = new Label("02  -  Demonstra segurança ao transmitir de forma"
                + "\n\t fidedigna informação relacionadas às"
        ...
        Label pergunta3 = new Label("03  -  Age com autonomia e responde pelos riscos"
                + "\n\t assumidos e resultados atingidos?");
        ...
        HBox hbox3 = new HBox(85);
        hbox3.getChildren().addAll(pergunta3, hboxCheck3);

        Label pergunta4 = new Label("04  -  Demonstra ética na condução de seu trabalho"
                + "\n\t construindo uma relação de confiança e de"
                + "\n\t respeito?");
        ...
        HBox hbox4 = new HBox(73);
        hbox4.getChildren().addAll(pergunta4, hboxCheck4);

        Label pergunta5 = new Label("05  -  Trata a todos com respeito e atenção,"
        ...
        btnCancelar.setOnAction((ActionEvent e) -> {
            ...
            float mediaLideranca = total / 5;
            funcionario.calcularAvaliacao(TipoAvaliacao.LIDERANCA, mediaLideranca);
        ...
        btnAvancar.setOnAction((ActionEvent e) -> {
            if (!chk11.isSelected() && !chk12.isSelected()
                ...
                float mediaLideranca = total / 5;
                funcionario.calcularAvaliacao(TipoAvaliacao.LIDERANCA, mediaLideranca);
                painelQuestionarioPontualidade(root, empresa, gestora, funcionario);
            }
        });
    ...
    private StackPane painelQuestionarioPontualidade(BorderPane root, Empresa empresa, Gestores gestora, Funcionario funcionario) {
        return new PainelQuestionarioPontualidade(root, empresa, gestora, funcionario);
    }
