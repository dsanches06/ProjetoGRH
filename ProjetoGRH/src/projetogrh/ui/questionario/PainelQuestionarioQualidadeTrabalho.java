 ...
 * @author
 */
public class PainelQuestionarioQualidadeTrabalho extends StackPane {
    ...
    public PainelQuestionarioQualidadeTrabalho(BorderPane root, Empresa empresa, Gestores gestora, Funcionario funcionario) {
    ...
    private void mostrarQuestionario(BorderPane root, VBox vbox3, Empresa empresa, Gestores gestora, Funcionario funcionario) {
        ...
        Text titulo = new Text("Questionário sobre Qualidade de Trabalho");
        ...
        Label pergunta1 = new Label("01  -  Realiza suas atividades de forma completa,"
                + "\n\t precisa e criteriosa, atendendo aos padrões"
        ...
        HBox hbox1 = new HBox(90);
        hbox1.getChildren().addAll(pergunta1, hboxCheck1);

        Label pergunta2 = new Label("02  -  Realiza os trabalhos sem necessidade de"
                + "\n\tde refazê-los em função de erros, evitando"
                + "\n\tdeixar pendências?");
        ...
        HBox hbox2 = new HBox(105);
        hbox2.getChildren().addAll(pergunta2, hboxCheck2);

        Label pergunta3 = new Label("03  -  Ensina o trabalho sob sua responsabilidade"
                + "\n\t a outros colegas, quando necessário?");
        ...
        HBox hbox3 = new HBox(94);
        hbox3.getChildren().addAll(pergunta3, hboxCheck3);

        Label pergunta4 = new Label("04  -  O funcionário faz com que as reclamações"
                + "\n\t dos clientes sejam minimizadas e esforça-se"
                + "\n\t para descobrir as principais queixas?");
        ...
        btnCancelar.setOnAction((ActionEvent e) -> {
            ...
            float mediaQualidadeTrabalho = total / 5;
            funcionario.calcularAvaliacao(TipoAvaliacao.QUALIDADE_TRABALHO, mediaQualidadeTrabalho);
        ...
        btnAvancar.setOnAction((ActionEvent e) -> {
            if (!chk11.isSelected() && !chk12.isSelected()
                ...
                int total = contador1 + contador2 + contador3 + contador4 + contador5;
                float mediaQualidadeTrabalho = total / 4;
                funcionario.calcularAvaliacao(TipoAvaliacao.QUALIDADE_TRABALHO, mediaQualidadeTrabalho);
                painelQuestionarioQuantidadeTrabalho(root, empresa, gestora, funcionario);
            }
        });

        VBox vboxDireito = new VBox(20);
    ...
    private StackPane painelQuestionarioQuantidadeTrabalho(BorderPane root, Empresa empresa, Gestores gestora, Funcionario funcionario) {
        return new PainelQuestionarioQuantidadeTrabalho(root, empresa, gestora, funcionario);
    }
