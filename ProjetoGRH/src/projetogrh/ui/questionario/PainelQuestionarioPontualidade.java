 ...
 * @author
 */
public class PainelQuestionarioPontualidade extends StackPane {
    ...
    public PainelQuestionarioPontualidade(BorderPane root, Empresa empresa, Gestores gestora, Funcionario funcionario) {
    ...
    private void mostrarQuestionario(BorderPane root, VBox vbox3, Empresa empresa, Gestores gestora, Funcionario funcionario) {
        ...
        Text titulo = new Text("Questionário sobre Pontualidade");
        ...
        Label pergunta1 = new Label("01  -  Chega a horas ou não?");
        ...
        HBox hbox1 = new HBox(243);
        hbox1.getChildren().addAll(pergunta1, hboxCheck1);

        Label pergunta2 = new Label("02  -  Cumpre rigorosamente o horário de trabalho"
                + "\n\t e a carga horária definida para sua função?");
        ...
        HBox hbox2 = new HBox(89);
        hbox2.getChildren().addAll(pergunta2, hboxCheck2);

        Label pergunta3 = new Label("03  -  Mostra-se comprometido com o cumprimento"
                + "\n\t de horários e de prazos para a entrega de suas"
                + "\n\t tarefas?");
        ...
        HBox hbox3 = new HBox(71);
        hbox3.getChildren().addAll(pergunta3, hboxCheck3);

        Label pergunta4 = new Label("04  -  Sabe planejar e administrar os horários de seus"
                + "\n\t compromissos respeitando sua agenda?");
        ...
        HBox hbox4 = new HBox(65);
        hbox4.getChildren().addAll(pergunta4, hboxCheck4);

        Label pergunta5 = new Label("05  -  Na ocorrência de algum imprevisto que venha a"
                + "\n\t interferir na assiduidade ou na pontualidade no"
                + "\n\t trabalho, preocupa-se em avisar a equipe e a"
                + "\n\t chefia imediatamente e em colocar-se disponível"
                + "\n\t para contornar os impactos decorrentes de sua "
                + "\n\t ausência?");
        ...
        btnCancelar.setOnAction((ActionEvent e) -> {
            ...
            float mediaPontualidade = total / 5;
            funcionario.calcularAvaliacao(TipoAvaliacao.PONTUALIDADE, mediaPontualidade);
        ...
        btnAvancar.setOnAction((ActionEvent e) -> {
            if (!chk11.isSelected() && !chk12.isSelected()
                ...
                float mediaPontualidade = total / 5;
                funcionario.calcularAvaliacao(TipoAvaliacao.PONTUALIDADE, mediaPontualidade);
                painelQuestionarioQualidadeTrabalho(root, empresa, gestora, funcionario);
            }
        });

        VBox vboxDireito = new VBox(15);
        vboxDireito.setAlignment(Pos.TOP_LEFT);
        vboxDireito.getChildren().addAll(hbox1,
                hbox2,
                hbox3,
                hbox4,
                hbox5);
    ...
    private StackPane painelQuestionarioQualidadeTrabalho(BorderPane root, Empresa empresa, Gestores gestora, Funcionario funcionario) {
        return new PainelQuestionarioQualidadeTrabalho(root, empresa, gestora, funcionario);
    }
