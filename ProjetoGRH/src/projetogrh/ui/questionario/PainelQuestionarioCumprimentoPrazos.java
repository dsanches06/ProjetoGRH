 ...
 * @author
 */
public class PainelQuestionarioCumprimentoPrazos extends StackPane {
    ...
    public PainelQuestionarioCumprimentoPrazos(BorderPane root, Empresa empresa, Gestores gestora, Funcionario funcionario) {
    ...
    private void mostrarQuestionario(BorderPane root, VBox vbox3, Empresa empresa, Gestores gestora, Funcionario funcionario) {
        ...
        Text titulo = new Text("Questionário sobre Cumprimento de Prazos ");
        ...
        Label pergunta1 = new Label("01  -  Planeja e prioriza a realização das tarefas"
                + "\n\t avalia o que é urgente e importante?");
        ...
        HBox hbox1 = new HBox(102);
        hbox1.getChildren().addAll(pergunta1, hboxCheck1);

        Label pergunta2 = new Label("02  -  Mostra-se comprometido com o cumprimento"
                + "\n\t de horários e de prazos para a entrega de "
                + "\n\t suas tarefas?");
        ...
        HBox hbox2 = new HBox(78);
        hbox2.getChildren().addAll(pergunta2, hboxCheck2);

        Label pergunta3 = new Label("03  -  Sabe planejar e administrar os horários de seus"
        ...
        HBox hbox3 = new HBox(62);
        hbox3.getChildren().addAll(pergunta3, hboxCheck3);

        Label pergunta4 = new Label("04  -  Sabe lidar com a pressão enfrentada no ambiente"
                + "\n\t de trabalho?");
        ...
        HBox hbox4 = new HBox(48);
        hbox4.getChildren().addAll(pergunta4, hboxCheck4);

        Label pergunta5 = new Label("05  -  Evita distrações no local de trabalho para"
                + "\n\t resistir às tentações de procrastinação"
                + "\n\t mais facilmente?");
        ...
        btnCancelar.setOnAction((ActionEvent e) -> {
            ...
            float mediaComprimentoPrazos = total / 5;
            funcionario.calcularAvaliacao(TipoAvaliacao.CUMPRIMENTO_DE_PRAZOS, mediaComprimentoPrazos);
        ...
        btnAvancar.setOnAction((ActionEvent e) -> {
            if (!chk11.isSelected() && !chk12.isSelected()
                ...
                float mediaComprimentoPrazos = total / 5;
                funcionario.calcularAvaliacao(TipoAvaliacao.CUMPRIMENTO_DE_PRAZOS, mediaComprimentoPrazos);
                painelQuestionarioLideranca(root, empresa, gestora, funcionario);
            }
        });

        VBox vboxDireito = new VBox(22);
    ...
    private StackPane painelQuestionarioLideranca(BorderPane root, Empresa empresa, Gestores gestora, Funcionario funcionario) {
        return new PainelQuestionarioLideranca(root, empresa, gestora, funcionario);
    }
