 ...
 * @author
 */
public class PainelQuestionarioComunicacao extends StackPane {
    ...
    public PainelQuestionarioComunicacao(BorderPane root, Empresa empresa, Gestores gestora, Funcionario funcionario) {
    ...
    private void mostrarQuestionario(BorderPane root, VBox vbox3, Empresa empresa, Gestores gestora, Funcionario funcionario) {
        ...
        Text titulo = new Text("Questionário sobre Comunicação");
        ...
        Label pergunta1 = new Label("01  -  Facilita o diálogo e a interação entre as"
                + "\n\t pessoas?");
        ...
        HBox hbox1 = new HBox(119);
        hbox1.getChildren().addAll(pergunta1, hboxCheck1);

        Label pergunta2 = new Label("02  -  É cortês com os colegas de trabalho?");
        ...
        HBox hbox2 = new HBox(135);
        hbox2.getChildren().addAll(pergunta2, hboxCheck2);

        Label pergunta3 = new Label("03  -  Possui equilíbrio emocional em situações"
                + "\n\t de conflito, tratando pessoas de forma"
                + "\n\t respeitosa, contornando com diplomacia"
                + "\n\t situações instaladas?");
        ...
        HBox hbox3 = new HBox(107);
        hbox3.getChildren().addAll(pergunta3, hboxCheck3);

        Label pergunta4 = new Label("04  -  Contribui visívelmente para a harmonia"
                + "\n\t das relações interpessoais internas e "
                + "\n\t externas?");
        ...
        HBox hbox4 = new HBox(124);
        hbox4.getChildren().addAll(pergunta4, hboxCheck4);

        Label pergunta5 = new Label("05  -  O colaborador dá feedbacks assertivos,"
                + "\n\t focados em fatos e em tom respeitoso,"
        ...
        btnCancelar.setOnAction((ActionEvent e) -> {
            ...
            float mediaComunicacao = total / 5;
            funcionario.calcularAvaliacao(TipoAvaliacao.COMUNICACAO, mediaComunicacao);
        ...
        btnAvancar.setOnAction((ActionEvent e) -> {
            if (!chk11.isSelected() && !chk12.isSelected()
                ...
                float mediaComunicacao = total / 5;
                funcionario.calcularAvaliacao(TipoAvaliacao.COMUNICACAO, mediaComunicacao);
                painelQuestionarioCumprimentoPrazos(root, empresa, gestora, funcionario);
            }
        });
    ...
    private StackPane painelQuestionarioCumprimentoPrazos(BorderPane root, Empresa empresa, Gestores gestora, Funcionario funcionario) {
        return new PainelQuestionarioCumprimentoPrazos(root, empresa, gestora, funcionario);
    }
