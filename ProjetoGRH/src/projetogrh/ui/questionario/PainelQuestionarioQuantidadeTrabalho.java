 ...
 * @author
 */
public class PainelQuestionarioQuantidadeTrabalho extends StackPane {
    ...
    public PainelQuestionarioQuantidadeTrabalho(BorderPane root, Empresa empresa, Gestores gestora, Funcionario funcionario) {
    ...
    private void mostrarQuestionario(BorderPane root, VBox vbox3, Empresa empresa, Gestores gestora, Funcionario funcionario) {
        ...
        Text titulo = new Text("Questionário sobre Quantidade de Trabalho");
        ...
        btnTerminar.setPrefSize(200, 30);
        ...
        Label pergunta1 = new Label("01  -  Possibilidade de conciliar o trabalho com a vida"
        ...
        HBox hbox1 = new HBox(63);
        hbox1.getChildren().addAll(pergunta1, hboxCheck1);

        Label pergunta2 = new Label("02  -  O volume de trabalho é limitado, produzindo"
                + "\n\t apenas o exigido?");
        ...
        Label pergunta3 = new Label("03  -  O volume de trabalho atende o esperado e"
                + "\n\t costuma exceder frequentemente?");
        ...
        HBox hbox3 = new HBox(102);
        hbox3.getChildren().addAll(pergunta3, hboxCheck3);

        Label pergunta4 = new Label("04  -  O volume de trabalho está sempre acima do"
                + "\n\t previsto e esperado?");
        ...
        HBox hbox4 = new HBox(90);
        hbox4.getChildren().addAll(pergunta4, hboxCheck4);

        Label pergunta5 = new Label("05  -  O volume de trabalho está abaixo da quantidade"
                + "\n\t esperada?");
        ...
        btnCancelar.setOnAction((ActionEvent e) -> {
            ...
            float mediaQuantidadeTrabalho = total / 5;
            funcionario.calcularAvaliacao(TipoAvaliacao.QUANTIDADE_TRABALHO, mediaQuantidadeTrabalho);
            funcionario.calcularDesempenho(gestora);
            retrocederDashBoard(root, empresa, gestora);
        });

        btnTerminar.setOnAction((ActionEvent e) -> {
        ...
        hboxBtn.getChildren().addAll(btnLimpar, btnCancelar, btnTerminar);
