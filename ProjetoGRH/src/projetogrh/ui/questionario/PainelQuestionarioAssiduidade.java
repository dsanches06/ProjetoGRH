 ...
 * @author
 */
public class PainelQuestionarioAssiduidade extends StackPane {
    ...
    public PainelQuestionarioAssiduidade(BorderPane root, Empresa empresa, Gestores gestora, Funcionario funcionario) {
    ...
    private void mostrarQuestionario(BorderPane root, VBox vbox3, Empresa empresa, Gestores gestora, Funcionario funcionario) {
        ...
        Text titulo = new Text("Questionário sobre Assiduidade");
        ...
        switch (funcionario.getGenero()) {
            case "F":
                ...
                fotoFuncionario.setFitHeight(30);
                fotoFuncionario.setFitWidth(30);
                break;
            case "M":
        ...
        switch (gestora.getGenero()) {
            case "F":
                ...
                fotoGestor.setFitHeight(30);
                fotoGestor.setFitWidth(30);
                break;
            case "M":
                //obter a imagem do perfil masculino
        ...
        Label pergunta1 = new Label("01  -  Raramente falta?");
        ...
        HBox hbox1 = new HBox(280);
        hbox1.getChildren().addAll(pergunta1, hboxCheck1);

        Label pergunta2 = new Label("02  -  Faltas ocasionais?");
        ...
        HBox hbox2 = new HBox(270);
        hbox2.getChildren().addAll(pergunta2, hboxCheck2);

        Label pergunta3 = new Label("03  -  Cumpre o horário estabelecido e é "
        ...
        HBox hbox3 = new HBox(154);
        hbox3.getChildren().addAll(pergunta3, hboxCheck3);

        Label pergunta4 = new Label("04  -  Nunca cumpre horário e está"
                + "\n\t sempre ausente?");
        ...
        HBox hbox4 = new HBox(197);
        hbox4.getChildren().addAll(pergunta4, hboxCheck4);

        Label pergunta5 = new Label("05  -  Normalmente não  cumpre"
                + "\n\t o horário estabelecido, mas,"
                + "\n\t quando presente atende às"
        ...
        btnCancelar.setOnAction((ActionEvent e) -> {
            ...
            float mediaAssiduidade = total / 5;
            funcionario.calcularAvaliacao(TipoAvaliacao.ASSIDUIDADE, mediaAssiduidade);
        ...
        btnAvancar.setOnAction((ActionEvent e) -> {
            if (!chk11.isSelected() && !chk12.isSelected()
                ...
                float mediaAssiduidade = total / 5;
                funcionario.calcularAvaliacao(TipoAvaliacao.ASSIDUIDADE, mediaAssiduidade);
                painelQuestionarioAutonomia(root, empresa, gestora, funcionario);
            }
        });

        VBox vboxDireito = new VBox(30);
        ...
        hboxGrid.getChildren().addAll(vboxPerfil, separador2, vbox);

        vbox3.getChildren().addAll(gridTitulo, hboxGrid);

    }

    private StackPane painelQuestionarioAutonomia(BorderPane root, Empresa empresa, Gestores gestora, Funcionario funcionario) {
        return new PainelQuestionarioAutonomia(root, empresa, gestora, funcionario);
    }
