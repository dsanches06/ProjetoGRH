 ...
 * @author
 */
public class PainelRegistarFuncionario extends StackPane {
    ...
    public PainelRegistarFuncionario(BorderPane root, Empresa empresa, Gestores gestora) {
        ...
        formulario(root, grid, empresa, gestora);
        root.setCenter(grid);
    }

    private void formulario(BorderPane root, GridPane grid, Empresa empresa, Gestores gestora) {
        Text titulo = new Text("Painel Registar Funcionarios");
        ...
        Button btnCriar = new Button("Registar Funcionarios");
        ...
        btnCriar.setOnAction((ActionEvent e) -> {
            ...
            if ((nomeFuncionario != null)
                ...
                Funcionario funcionario = new Funcionario(nomeFuncionario, genero, localidade, email, departamento, funcao, idade);

                if (empresa.adicionarFuncionario(funcionario) == true) {
                    Dialogo inf = new Dialogo(Alert.AlertType.INFORMATION);
                    //mostra o dialogo
                    inf.mostrarDialogo("INFORMAÇÃO", "Funcionario foi registado com sucesso");
                } else {
                    //cria o dialogo de erro
                    Dialogo erro = new Dialogo(Alert.AlertType.ERROR);
                    //mostra o dialogo
                    erro.mostrarDialogo("ERRO", "Funcionario não foi registado");
                }
